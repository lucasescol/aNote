        ...
        <div class="taskList">
            ...
            <?php foreach ($fetchTasks as $i => $task): ?>
                <?php if ($task["isDone"] == false): ?>
                    <div class='task'>
                        <div class='content'>
                                <svg id="checkbox" class="taskSquare" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-square" viewBox="0 0 16 16">
                ...
                <?php else: ?>
                    <div class='task'>
                        <div class='content'>
                            <svg id="checkbox" class="taskSquare" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2-square" viewBox="0 0 16 16">
